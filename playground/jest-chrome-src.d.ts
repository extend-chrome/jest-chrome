import { EventCallback, CallableEvent, EventSelector, MonotypeEventSelector } from "../src/create-event"
 ...
 * Permissions:  "alarms"
 */
export namespace JestChrome.alarms {
  ...
  export interface AlarmEvent extends JestChrome.events.Event<(alarm: Alarm) => void> {}
 ...
 */
export namespace JestChrome.browser {
 ...
 */
export namespace JestChrome.bookmarks {
  ...
  export interface BookmarkRemovedEvent extends JestChrome.events.Event<(id: string, removeInfo: BookmarkRemoveInfo) => void> {}

  export interface BookmarkImportEndedEvent extends JestChrome.events.Event<() => void> {}

  export interface BookmarkMovedEvent extends JestChrome.events.Event<(id: string, moveInfo: BookmarkMoveInfo) => void> {}

  export interface BookmarkImportBeganEvent extends JestChrome.events.Event<() => void> {}

  export interface BookmarkChangedEvent extends JestChrome.events.Event<(id: string, changeInfo: BookmarkChangeInfo) => void> {}

  export interface BookmarkCreatedEvent extends JestChrome.events.Event<(id: string, bookmark: BookmarkTreeNode) => void> {}

  export interface BookmarkChildrenReordered extends JestChrome.events.Event<(id: string, reorderInfo: BookmarkReorderInfo) => void> {}
 ...
 */
export namespace JestChrome.browserAction {
  ...
  export interface BrowserClickedEvent extends JestChrome.events.Event<(tab: JestChrome.tabs.Tab) => void> {}
 ...
 */
export namespace JestChrome.browsingData {
 ...
 * Manifest:  "commands": {...}
 */
export namespace JestChrome.commands {
  ...
  export interface CommandEvent extends JestChrome.events.Event<(command: string) => void> {}
 ...
 */
export namespace JestChrome.contentSettings {
 ...
 */
export namespace JestChrome.contextMenus {
  ...
  export interface CreateProperties {
     ...
     */
    onclick?: (info: OnClickData, tab: JestChrome.tabs.Tab) => void
  ...
  export interface MenuClickedEvent extends JestChrome.events.Event<(info: OnClickData, tab?: JestChrome.tabs.Tab) => void> {}
 ...
 */
export namespace JestChrome.cookies {
  ...
  export interface CookieChangedEvent extends JestChrome.events.Event<(changeInfo: CookieChangeInfo) => void> {}
 ...
 */
export namespace JestChrome.Debugger {
  ...
  export interface DebuggerDetachedEvent extends JestChrome.events.Event<(source: Debuggee, reason: string) => void> {}

  export interface DebuggerEventEvent extends JestChrome.events.Event<(source: Debuggee, method: string, params?: Record<string, any>) => void> {}
   ...
   * function(object result) {...};
   */
  export function sendCommand(target: Debuggee, method: string, commandParams?: Record<string, any>, callback?: (result?: Record<string, any>) => void): void
  /**
   * Since Chrome 28.
 ...
 */
export namespace JestChrome.declarativeContent {
  ...
  export interface PageChangedEvent extends JestChrome.events.Event<() => void> {}
...
////////////////////
export namespace JestChrome.declarativeWebRequest {
  ...
  export interface RequestedEvent extends JestChrome.events.DeclarativeContentEvent<Function> {}
 ...
 */
export namespace JestChrome.desktopCapture {
  /**
   ...
   * Parameter streamId: An opaque string that can be passed to getUserMedia() API to generate media stream that corresponds to the source selected by the user. If user didn't select any source (i.e. canceled the prompt) then the callback is called with an empty streamId. The created streamId can be used only once and expires after a few seconds when it is not used.
   */
  export function chooseDesktopMedia(sources: string[], targetTab: JestChrome.tabs.Tab, callback: (streamId: string) => void): number
  /**
 ...
 * Availability: Since Chrome 18.
 */
export namespace JestChrome.devtools.inspectedWindow {
  ...
  export interface Resource {
     ...
     */
    setContent(content: string, commit: boolean, callback?: (error: Record<string, any>) => void): void
  }
  ...
  export interface ResourceAddedEvent extends JestChrome.events.Event<(resource: Resource) => void> {}

  export interface ResourceContentCommittedEvent extends JestChrome.events.Event<(resource: Resource, content: string) => void> {}
 ...
 * Availability: Since Chrome 18.
 */
export namespace JestChrome.devtools.network {
  ...
  export interface RequestFinishedEvent extends JestChrome.events.Event<(request: Request) => void> {}

  export interface NavigatedEvent extends JestChrome.events.Event<(url: string) => void> {}
   ...
   */
  export function getHAR(callback: (harLog: Record<string, any>) => void): void
 ...
 * Availability: Since Chrome 18.
 */
export namespace JestChrome.devtools.panels {
  export interface PanelShownEvent extends JestChrome.events.Event<(window: Window) => void> {}

  export interface PanelHiddenEvent extends JestChrome.events.Event<() => void> {}

  export interface PanelSearchEvent extends JestChrome.events.Event<(action: string, queryString?: string) => void> {}
  ...
  export interface ButtonClickedEvent extends JestChrome.events.Event<() => void> {}
  ...
  export interface SelectionChangedEvent extends JestChrome.events.Event<() => void> {}
  ...
  export interface ExtensionSidebarPaneShownEvent extends JestChrome.events.Event<(window: JestChrome.windows.Window) => void> {}

  export interface ExtensionSidebarPaneHiddenEvent extends JestChrome.events.Event<() => void> {}
  ...
  export interface ExtensionSidebarPane {
     ...
     * function() {...};
     */
    setObject(jsonObject: Record<string, any>, rootTitle?: string, callback?: () => void): void
    /**
     * Sets a JSON-compliant object to be displayed in the sidebar pane.
     * @param jsonObject An object to be displayed in context of the inspected page. Evaluated in the context of the caller (API client).
     * @param callback A callback invoked after the sidebar is updated with the object.
     ...
     * function() {...};
     */
    setObject(jsonObject: Record<string, any>, callback?: () => void): void
    /**
   ...
   */
  export function setOpenResourceHandler(callback?: (resource: JestChrome.devtools.inspectedWindow.Resource) => void): void
  /**
   * Since Chrome 38.
 ...
 * Important: This API works only on Chrome OS.
 */
export namespace JestChrome.documentScan {
 ...
 */
export namespace JestChrome.downloads {
  ...
  export interface DownloadChangedEvent extends JestChrome.events.Event<(downloadDelta: DownloadDelta) => void> {}

  export interface DownloadCreatedEvent extends JestChrome.events.Event<(downloadItem: DownloadItem) => void> {}

  export interface DownloadErasedEvent extends JestChrome.events.Event<(downloadId: number) => void> {}

  export interface DownloadDeterminingFilenameEvent extends JestChrome.events.Event<(downloadItem: DownloadItem, suggest: (suggestion?: DownloadFilenameSuggestion) => void) => void> {}
 ...
 */
export namespace JestChrome.enterprise.platformKeys {
 ...
 * Note: This API is only for extensions pre-installed by policy.
 */
export namespace JestChrome.enterprise.deviceAttributes {
  /**
 ...
 */
export namespace JestChrome.events {
  ...
  export interface Event<C extends EventCallback> extends CallableEvent<C, MonotypeEventSelector<C>> {}
 ...
 * Availability: Since Chrome 5.
 */
export namespace JestChrome.extension {
  ...
  export interface OnRequestEvent
    extends JestChrome.events.Event<
      ((request: any, sender: runtime.MessageSender, sendResponse: (response: any) => void) => void) | ((sender: runtime.MessageSender, sendResponse: (response: any) => void) => void)
    > {}
 ...
 * Important: This API works only on Chrome OS.
 */
export namespace JestChrome.fileBrowserHandler {
  ...
  export interface FileBrowserHandlerExecuteEvent extends JestChrome.events.Event<(id: string, details: FileHandlerExecuteEventDetails) => void> {}
 ...
 * Important: This API works only on Chrome OS.
 */
export namespace JestChrome.fileSystemProvider {
  ...
  export interface RequestedEvent extends JestChrome.events.Event<(options: RequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface MetadataRequestedEvent
    extends JestChrome.events.Event<(options: MetadataRequestedEventOptions, successCallback: (metadata: EntryMetadata) => void, errorCallback: (error: string) => void) => void> {}

  export interface DirectoryPathRequestedEvent
    extends JestChrome.events.Event<
      (options: DirectoryPathRequestedEventOptions, successCallback: (entries: EntryMetadata[], hasMore: boolean) => void, errorCallback: (error: string) => void) => void
    > {}

  export interface OpenFileRequestedEvent extends JestChrome.events.Event<(options: OpenFileRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface OpenedFileRequestedEvent extends JestChrome.events.Event<(options: OpenedFileRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface OpenedFileOffsetRequestedEvent
    extends JestChrome.events.Event<(options: OpenedFileOffsetRequestedEventOptions, successCallback: (data: ArrayBuffer, hasMore: boolean) => void, errorCallback: (error: string) => void) => void> {}

  export interface DirectoryPathRecursiveRequestedEvent
    extends JestChrome.events.Event<(options: DirectoryPathRecursiveRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface EntryPathRecursiveRequestedEvent
    extends JestChrome.events.Event<(options: EntryPathRecursiveRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface FilePathRequestedEvent extends JestChrome.events.Event<(options: FilePathRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface SourceTargetPathRequestedEvent
    extends JestChrome.events.Event<(options: SourceTargetPathRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface FilePathLengthRequestedEvent
    extends JestChrome.events.Event<(options: FilePathLengthRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface OpenedFileIoRequestedEvent
    extends JestChrome.events.Event<(options: OpenedFileIoRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface OperationRequestedEvent extends JestChrome.events.Event<(options: OperationRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> {}

  export interface OptionlessRequestedEvent extends JestChrome.events.Event<(successCallback: Function, errorCallback: (error: string) => void) => void> {}
 ...
 */
export namespace JestChrome.fontSettings {
  ...
  export interface DefaultFixedFontSizeChangedEvent extends JestChrome.events.Event<(details: FontSizeDetails) => void> {}

  export interface DefaultFontSizeChangedEvent extends JestChrome.events.Event<(details: FontSizeDetails) => void> {}

  export interface MinimumFontSizeChangedEvent extends JestChrome.events.Event<(details: FontSizeDetails) => void> {}

  export interface FontChangedEvent extends JestChrome.events.Event<(details: FullFontDetails) => void> {}
   ...
   * function(object details) {...};
   */
  export function getDefaultFontSize(details?: Record<string, any>, callback?: (options: FontSizeDetails) => void): void
  /**
   ...
   * function(object details) {...};
   */
  export function getDefaultFixedFontSize(details?: Record<string, any>, callback?: (details: FontSizeDetails) => void): void
  /**
   ...
   * function() {...};
   */
  export function clearDefaultFontSize(details?: Record<string, any>, callback?: Function): void
  /**
   ...
   * function() {...};
   */
  export function clearMinimumFontSize(details?: Record<string, any>, callback?: Function): void
  /**
   ...
   * function() {...};
   */
  export function clearDefaultFixedFontSize(details: Record<string, any>, callback?: Function): void
 ...
 * Permissions:  "gcm"
 */
export namespace JestChrome.gcm {
  ...
  export interface MessageReceptionEvent extends JestChrome.events.Event<(message: IncomingMessage) => void> {}

  export interface MessageDeletionEvent extends JestChrome.events.Event<() => void> {}

  export interface GcmErrorEvent extends JestChrome.events.Event<(error: GcmError) => void> {}
 ...
 * Permissions:  "history"
 */
export namespace JestChrome.history {
  ...
  export interface HistoryVisitedEvent extends JestChrome.events.Event<(result: HistoryItem) => void> {}

  export interface HistoryVisitRemovedEvent extends JestChrome.events.Event<(removed: RemovedResult) => void> {}
 ...
 * @since Chrome 5.
 */
export namespace JestChrome.i18n {
 ...
 * @since Chrome 29.
 */
export namespace JestChrome.identity {
  /** @since Chrome 32. */
  ...
  export interface SignInChangeEvent extends JestChrome.events.Event<(account: AccountInfo, signedIn: boolean) => void> {}
 ...
 * @since Chrome 6.
 */
export namespace JestChrome.idle {
  export interface IdleStateChangedEvent extends JestChrome.events.Event<(newState: string) => void> {}
 ...
 * @since Chrome 21.
 */
export namespace JestChrome.input.ime {
  ...
  export interface BlurEvent extends JestChrome.events.Event<(contextID: number) => void> {}

  export interface CandidateClickedEvent extends JestChrome.events.Event<(engineID: string, candidateID: number, button: string) => void> {}

  export interface KeyEventEvent extends JestChrome.events.Event<(engineID: string, keyData: KeyboardEvent) => void> {}

  export interface DeactivatedEvent extends JestChrome.events.Event<(engineID: string) => void> {}

  export interface InputContextUpdateEvent extends JestChrome.events.Event<(context: InputContext) => void> {}

  export interface ActivateEvent extends JestChrome.events.Event<(engineID: string, screen: string) => void> {}

  export interface FocusEvent extends JestChrome.events.Event<(context: InputContext) => void> {}

  export interface MenuItemActivatedEvent extends JestChrome.events.Event<(engineID: string, name: string) => void> {}

  export interface SurroundingTextChangedEvent extends JestChrome.events.Event<(engineID: string, surroundingInfo: SurroundingTextInfo) => void> {}

  export interface InputResetEvent extends JestChrome.events.Event<(engineID: string) => void> {}
 ...
 * @since Chrome 8.
 */
export namespace JestChrome.management {
  ...
  export interface ManagementDisabledEvent extends JestChrome.events.Event<(info: ExtensionInfo) => void> {}

  export interface ManagementUninstalledEvent extends JestChrome.events.Event<(id: string) => void> {}

  export interface ManagementInstalledEvent extends JestChrome.events.Event<(info: ExtensionInfo) => void> {}

  export interface ManagementEnabledEvent extends JestChrome.events.Event<(info: ExtensionInfo) => void> {}
 ...
 * @since Chrome 43.
 */
export namespace JestChrome.networking.config {
  ...
  export interface CaptivePorttalDetectedEvent extends JestChrome.events.Event<(networkInfo: NetworkInfo) => void> {}
 ...
 * @since Chrome 28.
 */
export namespace JestChrome.notifications {
  ...
  export interface NotificationClosedEvent extends JestChrome.events.Event<(notificationId: string, byUser: boolean) => void> {}

  export interface NotificationClickedEvent extends JestChrome.events.Event<(notificationId: string) => void> {}

  export interface NotificationButtonClickedEvent extends JestChrome.events.Event<(notificationId: string, buttonIndex: number) => void> {}

  export interface NotificationPermissionLevelChangedEvent extends JestChrome.events.Event<(level: string) => void> {}

  export interface NotificationShowSettingsEvent extends JestChrome.events.Event<() => void> {}
   ...
   */
  export function getAll(callback: (notifications: Record<string, any>) => void): void
  /**
 ...
 * @since Chrome 9.
 */
export namespace JestChrome.omnibox {
  /** A suggest result. */
  ...
  export interface OmniboxInputEnteredEvent extends JestChrome.events.Event<(text: string, disposition: OnInputEnteredDisposition) => void> {}

  export interface OmniboxInputChangedEvent extends JestChrome.events.Event<(text: string, suggest: (suggestResults: SuggestResult[]) => void) => void> {}

  export interface OmniboxInputStartedEvent extends JestChrome.events.Event<() => void> {}

  export interface OmniboxInputCancelledEvent extends JestChrome.events.Event<() => void> {}

  export interface OmniboxSuggestionDeletedEvent extends JestChrome.events.Event<(text: string) => void> {}
 ...
 * @since Chrome 5.
 */
export namespace JestChrome.pageAction {
  export interface PageActionClickedEvent extends JestChrome.events.Event<(tab: JestChrome.tabs.Tab) => void> {}
 ...
 * @since Chrome 18.
 */
export namespace JestChrome.pageCapture {
 ...
 * @since Chrome 16.
 */
export namespace JestChrome.permissions {
 ...
 * @since Chrome 45.
 */
export namespace JestChrome.platformKeys {
   ...
   */
  export function getKeyPair(certificate: ArrayBuffer, parameters: Record<string, any>, callback: (publicKey: CryptoKey, privateKey: CryptoKey | null) => void): void
 ...
 * @since Chrome 27.
 */
export namespace JestChrome.power {
 ...
 * @since Chrome 44.
 */
export namespace JestChrome.printerProvider {
  ...
  export interface PrinterRequestedEvent extends JestChrome.events.Event<(resultCallback: (printerInfo: PrinterInfo[]) => void) => void> {}

  export interface PrinterInfoRequestedEvent extends JestChrome.events.Event<(device: any, resultCallback: (printerInfo?: PrinterInfo) => void) => void> {}

  export interface CapabilityRequestedEvent extends JestChrome.events.Event<(printerId: string, resultCallback: (capabilities: PrinterCapabilities) => void) => void> {}

  export interface PrintRequestedEvent extends JestChrome.events.Event<(printJob: PrintJob, resultCallback: (result: string) => void) => void> {}
 ...
 * @since Chrome 18.
 */
export namespace JestChrome.privacy {
 ...
 * @since Chrome 13.
 */
export namespace JestChrome.proxy {
  ...
  export interface ProxyErrorEvent extends JestChrome.events.Event<(details: ErrorDetails) => void> {}
 ...
 * Important: This API works only on Chrome OS.
 */
export namespace JestChrome.serial {
...
export namespace JestChrome.serial.onReceive {
...
export namespace JestChrome.serial.onReceiveError {
 ...
 * @since Chrome 22
 */
export namespace JestChrome.runtime {
  ...
  export interface PortDisconnectEvent extends JestChrome.events.Event<(port: Port) => void> {}

  export interface PortMessageEvent extends JestChrome.events.Event<(message: any, port: Port) => void> {}

  export interface ExtensionMessageEvent extends JestChrome.events.Event<(message: any, sender: MessageSender, sendResponse: (response?: any) => void) => void> {}

  export interface ExtensionConnectEvent extends JestChrome.events.Event<(port: Port) => void> {}

  export interface RuntimeInstalledEvent extends JestChrome.events.Event<(details: InstalledDetails) => void> {}

  export interface RuntimeEvent extends JestChrome.events.Event<() => void> {}

  export interface RuntimeRestartRequiredEvent extends JestChrome.events.Event<(reason: string) => void> {}

  export interface RuntimeUpdateAvailableEvent extends JestChrome.events.Event<(details: UpdateAvailableDetails) => void> {}
   ...
   */
  export function sendNativeMessage(application: string, message: Record<string, any>, responseCallback?: (response: any) => void): void
  /**
...
// Script Badge
////////////////////
export namespace JestChrome.scriptBadge {
  ...
  export interface ScriptBadgeClickedEvent extends JestChrome.events.Event<(tab: JestChrome.tabs.Tab) => void> {}
 ...
 * @since Chrome 37.
 */
export namespace JestChrome.sessions {
  ...
  export interface SessionChangedEvent extends JestChrome.events.Event<() => void> {}
 ...
 * @since Chrome 20.
 */
export namespace JestChrome.storage {
  export interface StorageArea {
     ...
     * Parameter items: Record<string, any> with items in their key-value mappings.
     */
    get(keys: string | string[] | Record<string, any> | null, callback: (items: { [key: string]: any }) => void): void
  }
  ...
  export interface StorageChangedEvent extends JestChrome.events.Event<(changes: { [key: string]: StorageChange }, areaName: string) => void> {}
...
// Socket
////////////////////
export namespace JestChrome.socket {
  ...
  export function create(type: string, options?: Record<string, any>, callback?: (createInfo: CreateInfo) => void): void
 ...
 * @since Chrome 32.
 */
export namespace JestChrome.system.cpu {
 ...
 * @since Chrome 32.
 */
export namespace JestChrome.system.memory {
 ...
 * @since Chrome 30.
 */
export namespace JestChrome.system.storage {
  ...
  export interface SystemStorageAttachedEvent extends JestChrome.events.Event<(info: StorageUnitInfo) => void> {}

  export interface SystemStorageDetachedEvent extends JestChrome.events.Event<(id: string) => void> {}
 ...
 * @since Chrome 30.
 */
export namespace JestChrome.system.display {
 ...
 * @since Chrome 31.
 */
export namespace JestChrome.tabCapture {
  ...
  export interface CaptureStatusChangedEvent extends JestChrome.events.Event<(info: CaptureInfo) => void> {}
 ...
 * @since Chrome 5.
 */
export namespace JestChrome.tabs {
  /**
  ...
  export interface TabHighlightedEvent extends JestChrome.events.Event<(highlightInfo: TabHighlightInfo) => void> {}

  export interface TabRemovedEvent extends JestChrome.events.Event<(tabId: number, removeInfo: TabRemoveInfo) => void> {}

  export interface TabUpdatedEvent extends JestChrome.events.Event<(tabId: number, changeInfo: TabChangeInfo, tab: Tab) => void> {}

  export interface TabAttachedEvent extends JestChrome.events.Event<(tabId: number, attachInfo: TabAttachInfo) => void> {}

  export interface TabMovedEvent extends JestChrome.events.Event<(tabId: number, moveInfo: TabMoveInfo) => void> {}

  export interface TabDetachedEvent extends JestChrome.events.Event<(tabId: number, detachInfo: TabDetachInfo) => void> {}

  export interface TabCreatedEvent extends JestChrome.events.Event<(tab: Tab) => void> {}

  export interface TabActivatedEvent extends JestChrome.events.Event<(activeInfo: TabActiveInfo) => void> {}

  export interface TabReplacedEvent extends JestChrome.events.Event<(addedTabId: number, removedTabId: number) => void> {}

  export interface TabSelectedEvent extends JestChrome.events.Event<(tabId: number, selectInfo: TabWindowInfo) => void> {}

  export interface TabZoomChangeEvent extends JestChrome.events.Event<(ZoomChangeInfo: ZoomChangeInfo) => void> {}
   ...
   */
  export function highlight(highlightInfo: HighlightInfo, callback?: (window: JestChrome.windows.Window) => void): void
  /**
 ...
 * @since Chrome 19.
 */
export namespace JestChrome.topSites {
 ...
 * @since Chrome 14.
 */
export namespace JestChrome.tts {
 ...
 * @since Chrome 14.
 */
export namespace JestChrome.ttsEngine {
  export interface SpeakOptions {
    /** Optional. The language to be used for synthesis, in the form language-region. Examples: 'en', 'en-US', 'en-GB', 'zh-CN'. */
    lang?: string
  ...
  export interface TtsEngineSpeakEvent extends JestChrome.events.Event<(utterance: string, options: SpeakOptions, sendTtsEvent: (event: JestChrome.tts.TtsEvent) => void) => void> {}
 ...
 * @since Chrome 13.
 */
export namespace JestChrome.types {
  ...
  export interface ChromeSettingChangedEvent extends JestChrome.events.Event<DetailsCallback> {}
 ...
 * @since Chrome 43.
 */
export namespace JestChrome.vpnProvider {
  ...
  export interface VpnPlatformMessageEvent extends JestChrome.events.Event<(id: string, message: string, error: string) => void> {}

  export interface VpnPacketReceptionEvent extends JestChrome.events.Event<(data: ArrayBuffer) => void> {}

  export interface VpnConfigRemovalEvent extends JestChrome.events.Event<(id: string) => void> {}

  export interface VpnConfigCreationEvent extends JestChrome.events.Event<(id: string, name: string, data: Record<string, any>) => void> {}

  export interface VpnUiEvent extends JestChrome.events.Event<(event: string, id?: string) => void> {}
 ...
 * @since Chrome 43.
 */
export namespace JestChrome.wallpaper {
 ...
 * @since Chrome 16.
 */
export namespace JestChrome.webNavigation {
  ...
  export interface WebNavigationEvent<T extends WebNavigationCallbackDetails> extends JestChrome.events.Event<(details: T) => void> {
 ...
 * @since Chrome 17.
 */
export namespace JestChrome.webRequest {
  ...
  export interface WebRequestBodyEvent extends JestChrome.events.Event<(details: WebRequestBodyDetails) => BlockingResponse | void> {
  ...
  export interface WebRequestHeadersSynchronousEvent extends JestChrome.events.Event<(details: WebRequestHeadersDetails) => BlockingResponse | void> {
  ...
  export interface WebRequestHeadersEvent extends JestChrome.events.Event<(details: WebRequestHeadersDetails) => void> {
    addListener(callback: (details: WebRequestHeadersDetails) => void, filter?: RequestFilter, opt_extraInfoSpec?: string[]): void
  }

  // eslint-disable-next-line
  export interface _WebResponseHeadersEvent<T extends WebResponseHeadersDetails> extends JestChrome.events.Event<(details: T) => void> {
    addListener(callback: (details: T) => void, filter?: RequestFilter, opt_extraInfoSpec?: string[]): void
  }

  export interface WebResponseHeadersEvent extends JestChrome.events.Event<(details: WebResponseHeadersDetails) => BlockingResponse | void> {
  ...
  export interface WebAuthenticationChallengeEvent extends JestChrome.events.Event<(details: WebAuthenticationChallengeDetails, callback?: (response: BlockingResponse) => void) => void> {
 ...
 * @since Chrome 15.
 */
export namespace JestChrome.webstore {
  /**
  ...
  export interface InstallationStageEvent extends JestChrome.events.Event<(stage: string) => void> {}

  export interface DownloadProgressEvent extends JestChrome.events.Event<(percentDownloaded: number) => void> {}
 ...
 * @since Chrome 5.
 */
export namespace JestChrome.windows {
  ...
  export interface WindowIdEvent extends JestChrome.events.Event<(windowId: number, filters?: WindowEventFilter) => void> {}

  export interface WindowReferenceEvent extends JestChrome.events.Event<(window: Window, filters?: WindowEventFilter) => void> {}
  ...
  export function get(windowId: number, callback: (window: JestChrome.windows.Window) => void): void
  /**
   * Gets details about a window.
   * @since Chrome 18.
   */
  export function get(windowId: number, getInfo: GetInfo, callback: (window: JestChrome.windows.Window) => void): void
  /**
   * Gets the current window.
   */
  export function getCurrent(callback: (window: JestChrome.windows.Window) => void): void
  /**
   * Gets the current window.
   * @since Chrome 18.
   */
  export function getCurrent(getInfo: GetInfo, callback: (window: JestChrome.windows.Window) => void): void
  /**
   * Creates (opens) a new browser with any optional sizing, position or default URL provided.
   * @param callback
   * Optional parameter window: Contains details about the created window.
   */
  export function create(callback?: (window?: JestChrome.windows.Window) => void): void
  /**
   * Creates (opens) a new browser with any optional sizing, position or default URL provided.
   * @param callback
   * Optional parameter window: Contains details about the created window.
   */
  export function create(createData: CreateData, callback?: (window?: JestChrome.windows.Window) => void): void
  /**
   * Gets all windows.
   */
  export function getAll(callback: (windows: JestChrome.windows.Window[]) => void): void
  /**
   * Gets all windows.
   * @since Chrome 18.
   */
  export function getAll(getInfo: GetInfo, callback: (windows: JestChrome.windows.Window[]) => void): void
  /** Updates the properties of a window. Specify only the properties that you want to change; unspecified properties will be left unchanged. */
  export function update(windowId: number, updateInfo: UpdateInfo, callback?: (window: JestChrome.windows.Window) => void): void
  /** Removes (closes) a window, and all the tabs inside it. */
  export function remove(windowId: number, callback?: Function): void
  /**
   * Gets the window that was most recently focused — typically the window 'on top'.
   */
  export function getLastFocused(callback: (window: JestChrome.windows.Window) => void): void
  /**
   * Gets the window that was most recently focused — typically the window 'on top'.
   * @since Chrome 18.
   */
  export function getLastFocused(getInfo: GetInfo, callback: (window: JestChrome.windows.Window) => void): void
